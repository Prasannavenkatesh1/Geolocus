...
//        callButton.targetForAction(nil, withSender: self)
        ...
        print("deviceID : \(deviceId), countryCode : \(countryCode), token : \(token), accountId : \(accountId), accountCode : \(accountCode)")
...
//        dashboardData = DashboardDB.sharedInstance().fetchLastData()
        ...
        if (countryCode == "IN" || countryCode != nil) {
            ...
            print("Value of Speed Limit IN : \(mainDelegate.speedLimit)")
            print("Distance Driven : \(convertedDistanceDriven)")
            ...
            print("Value of Speed Limit US : \(mainDelegate.speedLimit)")
        
        }
        
        print(convertedDistanceDriven?.description)
        ...
        print("The value of driverScore is : \(driverScore)")
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        let checkStart = defaults.boolForKey("isStarted")
    ...
    func addArcView(score : String) {
        ...
        print("Recieved Value of driverScore is : \(score)")
