...
(function ($) {
    ...
    $.fn.percentageLoader = function (params) {
        ...
        innerGrad.addColorStop(0, '#d3d3d3');
        innerGrad.addColorStop(1, '#d3d3d3');

        /* Tube gradient (background, not the spiral gradient) */
        tubeGrad = ctx.createLinearGradient(cX, 0, cX, canvas.height);
        tubeGrad.addColorStop(0, '#d3d3d3');
        tubeGrad.addColorStop(1, '#d3d3d3');
        ...
        * than true / false */
        ...
        drawLoader = function () {
            ...
            makeInnerTubePath(startAngle, endAngle,20,21);
            ...
            (function () {
                ...
                percentageText.style.fontFamily = "digital-7";
